...
print("Мне", 16, "лет")</pre>
      ...
      <p><strong>📌 Задание:</strong> Создай переменную <code>city</code>, запиши в неё название своего города, а затем выведи на экран фразу <code>"Я живу в городе [город]"</code>.</p>
      <p><em>Подсказка: используй <code>print("Я живу в городе", city)</code></em></p>
    `,
    starterCode: ``,
  },
